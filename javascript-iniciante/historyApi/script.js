...
// winwow.history.forward(); // Vai para a próxima

//pushState()
//A parte interessante de manipularmos o history é que podemos modificar o histórico e adicionar um novo item.
// window.history.pushState(obj, title, url)

//Em obj podemos enviar um objeto com dados mas o seu uso pe restrito por isso geralmente utilizamos null. O title ainda é ignorado por alguns browsers, também utilizamos null nele. O url que é a parte importante. 
...
//Fetch e History 
//Ao pucarmos dados via fetch api, o url da página continua o mesmo. Ao combinar fetch com a history api conseguimos simular uma navegação real entre páginas, sem a necessidade de recarregamento da mesma. 
